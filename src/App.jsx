...
const engagementDatabase = {
  "Zamboanga City": [
    ...
    { date: "Dec 2023", title: "Singapore's SA Geolab International Pte Ltd establishes world-class geotechnical soil testing facility.", source: "Verified Corporate PR" },
    { date: "Jun 2023", title: "USAID Cities for Enhanced Governance and Engagement (CHANGE) MOU signed for democratic governance.", source: "LGU Portal" }
  ],
  "Puerto Princesa City": [
    { date: "Jan 2026", title: "South Korean investors propose waste-to-energy and utility projects.", source: "Regional Monitor" },
  ...
  "Subic": [
    { date: "May 2024", title: "U.S. Trade and Development Agency (USTDA) steps in to fund the Subic-Clark-Manila-Batangas railway.", source: "Cambridge Core / Geo-Econ" },
  ...
  "Marawi City": [
    { date: "2024-2025", title: "USAID, JICA, and Saudi Arabia's KSrelief pour millions into transitional shelters and UN joint work plans.", source: "PACOM / Gov" }
  ],
  "Cotabato City": [
...
const lguData = [
  ...
  { id: 4, name: "Cagayan", province: "Cagayan", region: "Region II", typology: "A+C", shade: "Red", lceName: "EDGAR AGLIPAY", age: "58", term: "1st term", background: "Retired PNP Chief and PMA graduate. Navigates Cagayan’s strategic role as a 'Gateway to the North'.", totalScore: 0.2927, stats: { psgc: "021500000", pop: "1,268,603", income: "1st Class", urbanRural: "Mixed", coastal: "Yes" }, coords: { x: 48, y: 15 }, 
...
const PhMapSvg = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full text-slate-800 drop-shadow-md" preserveAspectRatio="xMidYMid meet">
